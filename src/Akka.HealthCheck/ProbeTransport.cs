...
namespace Akka.HealthCheck
{
    ...
    public enum ProbeTransport
    {
        ...
        /// </summary>
        /// <remarks>
        /// See https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/#define-a-liveness-command for example.
        /// </remarks>
        File,
        ...
        /// 
        /// See https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/#define-a-tcp-liveness-probe
        /// </remarks>
        TcpSocket,
