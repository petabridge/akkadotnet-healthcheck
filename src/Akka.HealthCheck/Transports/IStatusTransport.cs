...
namespace Akka.HealthCheck.Transports
{
    ...
    public interface IStatusTransport
    {
        ...
        /// <returns>A task with a status of <c>true</c> or <c>false</c>. If
        /// <c>false</c>, we failed to write the updated status to the transport.</returns>
        ...
        /// <param name="token">A cancellation token.</param>
        /// <returns>A task with a status of <c>true</c> or <c>false</c>. If
        /// <c>false</c>, we failed to close the transport.</returns>
