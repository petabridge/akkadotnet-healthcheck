...
namespace Akka.HealthCheck.Persistence.Tests
{
    public static class TestConfig
    {
        ...
        public static string GetCustomConfigurationString = @"akka.persistence {
                                         journal {
                                                    inmem.class = ""Akka.HealthCheck.Persistence.Tests.AkkaPersistenceLivenessProbeHandlesPersistenceBecomingUnavailableSpecs+DoomedMemoryJournal""
                                                    plugin = ""akka.persistence.journal.sqlite""
                                                    recovery-event-timeout = 2s
                                                    circuit-breaker.reset-timeout = 2s
                                                    sqlite {
