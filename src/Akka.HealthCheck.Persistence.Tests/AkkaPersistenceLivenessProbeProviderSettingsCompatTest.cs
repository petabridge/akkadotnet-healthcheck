...
{
    public class AkkaPersistenceLivenessProbeProviderSettingsCompatTest : TestKit.Xunit.TestKit
    {

        public AkkaPersistenceLivenessProbeProviderSettingsCompatTest(ITestOutputHelper helper)
